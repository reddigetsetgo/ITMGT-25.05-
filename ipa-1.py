...
def body_mass_index(weight, height):
    ...
    meters = (height[0] * 0.305) + (height[1] * 0.0254) #conversion of foot and inches to meters 
    kg = (weight*0.453592) #conversion of lbs to kg 

    bmi = kg / (meters**2) 

    return((bmi))

print(body_mass_index(110,[5,6]))
